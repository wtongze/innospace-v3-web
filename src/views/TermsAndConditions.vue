<template>
  <v-container class="terms-of-service px-4 py-8 legal-doc">
    ...
    <p>
      ...
      third parties on the Service, you agree to use the Service at your own risk. You understand
      that by using the Service You may be exposed to content that You may find offensive, indecent,
    ...
    <p>
      Although regular backups of Content are performed, the Company do not guarantee there will be
    ...
    <p>
      ...
      our copyright agent via email at contact@innospace.io and include in Your notice a detailed
    ...
    <p>
      You can contact our copyright agent via email at contact@innospace.io. Upon receipt of a
