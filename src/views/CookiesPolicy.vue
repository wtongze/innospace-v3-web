<template>
  <v-container class="cookies-policy px-4 py-8 legal-doc">
    <h1 class="mt-0">Cookies Policy</h1>
    <p>Last updated: October 27, 2020</p>
    <p>
      This Cookies Policy explains what Cookies are and how We use them. You should read this policy
    ...
    <ul>
      <li>
        ...
        &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to InnoSpace.
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        ...
        <p>Administered by: Third-Parties</p>
        <p>
          Purpose: In addition to Our own Cookies, We may also use various third party plug-ins from
          social media networking websites such as Facebook, Instagram, Twitter or Google+ to report
          usage statistics of the Website and to provide social media features. These third party
          plug-ins may store Cookies. We do not control these Social Media Cookies. Please refer to
          the relevant social media networking's website privacy policies for information about
          their cookies.
        </p>
      </li>
    </ul>
