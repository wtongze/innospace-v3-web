<template>
  <v-container class="privacy-policy px-4 py-8 legal-doc">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          refers to the Company as the legal entity that collects Consumers' personal information
      ...
      <li>
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to InnoSpace.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          means, a Consumer's personal information to another business or a third party for monetary
      ...
      <li>
        <p>
          <strong>Website</strong> refers to InnoSpace, accessible from
          <a href="https://innospace.io" rel="external nofollow noopener" target="_blank"
            >https://innospace.io</a
          >
        </p>
      </li>
      <li>
      ...
      <li>
        ...
        <p>
          ...
          <a
            ...
            rel="external nofollow noopener"
            target="_blank"
            >https://www.mailjet.com/privacy-policy/</a
          >
        </p>
      </li>
    </ul>
    ...
    <p>
      ...
      collect or may have been collected from California residents within the last twelve (12)
      months.
    </p>
    <p>
      Please note that the categories and examples provided in the list below are those defined in
      the CCPA. This does not mean that all examples of that category of personal information were
      in fact collected by Us, but reflects our good faith belief to the best of our knowledge that
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          financial information, medical information, or health insurance information. Some personal
    ...
    <p>
      ...
      that all examples of that category of personal information were in fact disclosed, but
    ...
    <p>
      ...
      information by the business to a third party for valuable consideration. This means that We
      may have received some kind of benefit in return for sharing personal Iinformation, but not
    ...
    <p>
      ...
      of age, unless We receive affirmative authorization (the &quot;right to opt-in&quot;) from
      either the Consumer who is between 13 and 16 years of age, or the parent or guardian of a
      Consumer less than 13 years of age. Consumers who opt-in to the sale of personal information
      may opt-out of future sales at any time. To exercise the right to opt-out, You (or Your
    ...
    <ul>
      <li>By email: contact@innospace.io</li>
    </ul>
    <p>
    ...
    <p>
      ...
      extended once by an additional 45 days when reasonable necessary and with prior notice.
    </p>
    <p>
    ...
    <p>
      ...
      use technology on the Service that sells personal information as defined by the CCPA law. If
      you wish to opt out of the use of Your personal information for interest-based advertising
    ...
    <p>
      ...
      that You do not want to be tracked. You can enable or disable DNT by visiting the preferences
